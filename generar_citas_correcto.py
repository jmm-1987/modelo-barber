#!/usr/bin/env python3
"""
Script para generar citas con el orden correcto de columnas
"""
...
def generar_citas_correcto():
    """Genera citas con el orden correcto de columnas"""
    ...
    for dia_offset in range(7):
        ...
        for hora in horas_multiples:
            ...
            for i, (peluquero_id, peluquero_nombre) in enumerate(peluqueros_seleccionados):
                ...
                # Insertar cita con el orden correcto de columnas
                c.execute('''
